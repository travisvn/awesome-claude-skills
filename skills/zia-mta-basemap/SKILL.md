...
description: The canonical AGL, civil-duct and MTA segmentation basemap for Zayed International Airport (ZIA/OMAA), extracted from the Z1-Z2-Z3 MTA Segmentation drawing. Use this skill whenever a task involves ZIA airfield geometry - plotting or counting AGL assets (taxiway centreline, edge, stop bar, lead-in, holding, RGL/RRM, signs, sign foundations, light bases), tracing secondary cable, duct, ductbank, conduit or sawcut routes, locating handholes and transformer pits, working with MTA milling/overlay segmentation IDs, or producing AGL impact sketches, RFI location plans, defect overlays and work completion drawings. Trigger it even when the user only says "plot the stop bars in that area", "how many centreline lights here", "is there secondary cable under the patch", "overlay the segmentation", "AGL impact of the milling", or names a segment ID like TE5.1 / K1.3 / 601.1 - and trigger it before reaching for the source DWG/DXF, because the extracted data here is already parsed and indexed.
---
