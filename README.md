...
| **[OpenOutreach](https://github.com/eracle/OpenOutreach)** | Find B2B leads from a session — drives a self-hosted CLI that qualifies each lead with an LLM and prints the reason alongside the CSV |
