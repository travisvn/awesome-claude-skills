...
| **[windows-health-check](https://github.com/codepros100-dev/claude-windows-health-check)** | Comprehensive Windows system health check, diagnostics & remediation -- runs 7 parallel PowerShell audits (security, hardware, services, network, performance, software, system), generates scored report, and offers automated fixes |
