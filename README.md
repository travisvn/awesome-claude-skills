...
| **[audit-flow](https://github.com/ArunJRK/audit-flow)** | Systematic flow tracing across CODE, API, AUTH, DATA, NETWORK layers with SQLite persistence and Mermaid export. Use for security audits, brainstorming, debugging, architecture reviews, documentation, and incident post-mortems. Zero dependencies. |
