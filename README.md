...
| **[Ontoly](https://github.com/0xsarwagya/ontoly)** | Deterministic Software Graph, MCP server, and agent skills for architecture review, request tracing, impact analysis, and dependency analysis |
