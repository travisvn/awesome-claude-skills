...
| **[listen-book](https://github.com/QINGcha7911/listen-book)** | Turn any book into an audio summary — all ages (0-3 to 18+), 6 scenarios (commute/running/bedtime/parent-child), 5 Chinese voices + free voice cloning (mommy/daddy's voice tells kids stories), streaming delivery (first segment in 30s), content safety filter, copyright-compliant (public info/public domain books) |
