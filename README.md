...
| **[skyvern-browser-automation](https://github.com/mark1ian/skyvern-skills)** | Browser automation via Skyvern MCP for website navigation, form filling, authenticated flows, and structured data extraction |
