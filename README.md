...
| **[websearch-fallback](https://github.com/samart/claude-websearch-fallback-skill)** | Fallback web search and URL fetching using local Chrome browser when built-in WebSearch/WebFetch tools fail |
