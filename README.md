...
| **[ThumbGate](https://github.com/IgorGanapolsky/ThumbGate)** | Pre-action gates for AI coding agents — captures thumbs-up/down feedback, auto-promotes repeated failures into prevention rules, and blocks known-bad tool calls via PreToolUse hooks. Thompson Sampling, LanceDB vectors, DPO export. |
