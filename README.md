...
| **[easetoolz-seo](https://github.com/ariarihantmedia-bit/easetoolz-seo-skill)** | Universal SEO + GEO skill — technical audit, competitor analysis, schema generation, blog writing (Hindi+English), SERP clustering. Built for tool sites & SaaS |
