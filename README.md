...
| **[faceleg/claude-skill-git](https://github.com/faceleg/claude-skill-git)** | Atomic commits, staging strategy, and conventional commit messages with enforced user approval |
