...
| Skill | Description |
| --- | --- |
| **[diachron](https://github.com/wolfiesch/diachron)** | Provenance tracking for AI-assisted development - automatically capture every code change to a queryable timeline with git integration and AI summaries |
