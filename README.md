...
| **[okf-skills](https://github.com/scaccogatto/okf-skills)** | Author, validate, and visualize Open Knowledge Format (OKF) knowledge bundles: portable markdown that both humans and coding agents read |
