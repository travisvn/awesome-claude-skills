...
- **[vibe-check](https://github.com/gtskevin/vibe-check)** - Quality gate for AI-generated code
  - Single SKILL.md that checks security, correctness, structure, performance, testing, and documentation
