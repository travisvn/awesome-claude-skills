...
| **[adversarial-verify](https://github.com/Arykozhang/adversarial-verify)** | Pack any project into structured materials for adversarial AI audits — get P0/P1/P2-graded findings, file references, and fix specs to break through performance bottlenecks. MIT licensed. |
