...
| **[verify-before-code](https://github.com/Morningstar202604/AgentSeed)** | Anti-hallucination guardrail skill (part of the AgentSeed plugin): binds every coding task to an SDD contract and enforces verification before completion - AST undefined-symbol detection, hallucination-signal scanning, sandboxed test runs, and evidence-backed completion reports via six companion MCP tools |
