...
| **[chainaware-behavioral-prediction](https://github.com/ChainAware/behavioral-prediction-mcp/blob/main/SKILL.md)** | ChainAware Skill for AI-powered tools to analyze wallet behaviour prediction,fraud detection and rug pull prediction |
