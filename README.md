...
| **[sap-gui-scripting](https://github.com/blazerinho/sap-gui-scripting-skill)** | Python automation skill for SAP GUI Scripting API (win32com.client) — session handling, control discovery, error handling, SE16H data analytics queries |
