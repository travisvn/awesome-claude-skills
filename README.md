...
| **[embercore](https://github.com/embercore-labs/embercore)** | MCP-native AI marketing agent toolkit with five specialized agents (Athena, Hermes, Apollo, Hephaestus, Hestia) for strategy, execution, copywriting, building, and memory across the full marketing pipeline |
