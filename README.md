...
- **[avifenesh/agnix](https://github.com/avifenesh/agnix)** - Linter for AI agent configurations. Validates SKILL.md, CLAUDE.md, hooks, MCP, and more with 156 rules, auto-fix, and real-time editor diagnostics via LSP.
