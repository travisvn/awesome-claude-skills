...
- **[TeamHero](https://github.com/sagiyaacoby/TeamHero)** - Multi-agent orchestration platform - manage teams of Claude Code agents with a web dashboard, task lifecycle, and knowledge base
