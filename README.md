...
| **[autoplex](https://github.com/ZenAlexa/autoplex)** | Autonomous multi-phase plan execution — runs complex task plans unattended via `claude -p` headless sessions with per-task retry, phase-level quality gates, and cross-verification |
