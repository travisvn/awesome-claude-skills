...
| **[Eidetic](https://github.com/LARIkoz/eidetic)**                                      | Long-term memory for Claude Code — FTS5 search (50ms), auto context injection via rules/ (59+ behavioral rules always visible), session signal extraction with compounding, evidence tiers with 0.5x self-referential discount. Zero deps (bash + python3 + sqlite3) |
