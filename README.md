...
| **[resolve-multicam-workflow](https://github.com/web594/resolve-multicam-workflow)** | DaVinci Resolve Studio automation: audio sync, auto multicam cut from a Whisper transcript, film-look grading via shared Color-Group nodes, non-destructive blur/shake QC with angle switching, overlay titles |
