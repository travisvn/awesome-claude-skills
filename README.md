...
| **[EGC](https://github.com/Fmarzochi/EGC)** | Persistent cross-session memory MCP server for Claude Code and 12 other AI coding tools. SQLite-backed, install with `npm install -g @egchq/egc` |
