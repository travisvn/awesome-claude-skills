...
| **[AgentFund](https://github.com/RioTheGreat-ai/agentfund-mcp)** | Crowdfunding for AI agents with milestone-based escrow on Base chain. Create funding proposals, track projects, receive payments |
