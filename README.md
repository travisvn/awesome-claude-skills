...
| **[extract-design-soul-dashboard](https://github.com/yigitkonur/extract-design-soul-dashboard)** | Forensic visual DNA extraction for SaaS dashboard codebases. Produces pixel-perfect documentation of every token, component, state, and animation — enough for someone to recreate the exact look-and-feel without copying source code. |
