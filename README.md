...
| **[interactive-html](https://github.com/machbuilds/interactive-html)** | Comment on local HTML pages — highlight text, pick an element, drag a region, or ask a question; the agent edits the HTML and the page reloads with a tour of what changed. Open file-based protocol; works with Claude Code, Cursor, or any agent CLI |
