...
| **[building-autonomous-team](https://github.com/fengjunhui/building-autonomous-team)** | Mission-driven autonomous dev team plugin — 2 persistent agents + dynamic spawning, GitHub-only state, two-round perspective discussions, 5 task types, auto-generates work via mission analysis |
