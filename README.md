...
| **[compliant-logging (Throughproof)](https://github.com/sylvain-gagnier/throughproof)** | Writes SOC 2-ready audit logging (CC7.2) for sensitive actions and keeps secrets/PII out of logs — portable across Claude Code, Cursor, Copilot & Gemini |
