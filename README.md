...
| **[Family OS](https://github.com/living-hi/family-os)** | Privacy-first household operating system for AI agents with local workspaces, multilingual templates, dashboards, projects, decisions, and family memory |
