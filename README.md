...
| **[eliniscan](https://github.com/AlpYenigun/eliniscan)** | AI full codebase scanner — opens a separate Claude session for every file, reads every line, finds bugs/security/performance issues, auto-fixes. Tested on 189K lines. |
