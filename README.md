...
| **[ai-powered-literature-review](https://github.com/stephenlzc/AI-Powered-Literature-Review-Skills)** | Systematic academic literature review with an 8-phase workflow and agent-swarm architecture, compatible with Claude Code and other AI coding tools |
