...
| **[sequenzy-email-marketing](https://github.com/Sequenzy/skills/tree/main/skills/sequenzy-email-marketing)** | Operate Sequenzy email marketing and transactional email workflows: auth, subscribers, campaigns, sequences, templates, and product emails |
