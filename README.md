...
| **[moyu](https://github.com/uucz/moyu)** | Anti-over-engineering skill — constrains AI to write minimal code. Three iron rules: only change what was asked, simplest solution first, ask when unsure. Benchmarked: 66% code reduction |
