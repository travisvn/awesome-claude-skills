...
| **[axiom-kit](https://github.com/bedderautomation-svg/axiom-kit)** | Persistent cognitive architecture — state survives context compaction via hooks, MCP bootstrap, and memory files. Based on published refusal geometry research (21 peer-reviewed papers) |
