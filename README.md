...
- **[claude-overlay](https://github.com/mzmmoazam/claude-overlay)** - CLI to configure Claude Code for custom providers (Databricks, Bedrock, OpenRouter, LiteLLM) with MCP web search setup
