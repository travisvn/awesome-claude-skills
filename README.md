...
| **[huiyu-safe-ai](https://github.com/huiyu9144/huiyu-safe-ai)** | Lightweight AI security guard for install/download commands. Blocks 68+ malicious packages, verifies identity, scans code — zero overhead, <1s. |
