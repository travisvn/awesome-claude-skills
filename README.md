...
| **[shelter-skill](https://github.com/nextauralabs/shelter-skill)** | Connect agents to real bank data — safe-to-spend, cash forecasts, zombie subscriptions, affordability checks, and AI coaching via Plaid |
