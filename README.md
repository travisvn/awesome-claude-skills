...
| **[OZC](https://github.com/joemekw-code/ozc)** | Trust infrastructure for AI-generated information with on-chain verification on Base. Provides MCP server tools for stake, verify, and search operations. |
