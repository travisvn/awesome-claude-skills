...
| **[business-tracker](https://github.com/k1r3zz/kira-claude-code/tree/main/skills/business-tracker)** | Auto-extract business logic from any codebase into living documentation. Supports Flutter, Node.js, Go, Python, Java, .NET, Rust, Ruby, PHP, iOS |
