...
| **[Screex](https://github.com/blueprintparadise/Screex)** | Turns a screen recording into a queryable index of UI states (OCR text, what changed, typed actions) for transcripts, Q&A, and bug reports |
