...
| **[skill-auditor](https://github.com/lee-fuhr/skill-auditor)** | Normalize components from any source into production-ready parts. Security scanning + performance optimization + multi-source normalization for skills, agents, hooks, and plugins |
