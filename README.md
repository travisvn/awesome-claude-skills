...
| **[logprobs](https://github.com/andrewBatutin/verifier_primacy)** | Analyze LLM token probabilities for confidence calibration - complete, score, and compare modes with perplexity and uncertainty metrics |
