...
| **[octav-api-skill](https://github.com/Octav-Labs/octav-api-skill)** | Query Octav's crypto portfolio API: wallet balances, transaction history, DeFi positions, and token analytics across 20+ chains |
