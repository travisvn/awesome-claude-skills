...
| **[OpenPaw](https://github.com/daxaur/openpaw)** | Turns Claude Code into a personal assistant with 38 skills — email, calendar, Spotify, smart home, Slack, GitHub, and more. Install via `npx pawmode`. |
