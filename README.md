...
| **[nanobananas-api-guide](https://github.com/ailingqu/nanobananas-api-guide)** | AI image & video generation API guide with 5 image models, 4 video models, pricing reference, and ready-to-use Python/Node.js/cURL examples |
