...
| **[lendtrain-mortgage](https://github.com/lendtrain/mortgage)** | AI-native mortgage refinance plugin with real-time institutional pricing, state-specific closing costs, FHA Streamline/VA IRRRL detection, and regulatory compliance. No API key required |
