...
- **[BrowserAct Skills](https://github.com/browser-act/skills)** - 22 browser automation skills for extracting structured data from Amazon, YouTube, Google Maps, Reddit, WeChat, and Zhihu using real browser instances
