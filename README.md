...
| **[component-hardener](https://github.com/lee-fuhr/component-hardener)** | Normalize components from any source into production-ready parts. Security scanning + performance optimization + multi-source normalization for skills, agents, hooks, and plugins |
