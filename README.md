...
| **[renwei](https://github.com/dbhosbu-dotcom/renwei)** | Book-length Chinese de-AI editor. 51 rules across AI tells, Euro-Chinese syntax, and whole-book consistency (contradictions, unresolved setups, metaphor collisions). Ships a token-free lint CLI. |
