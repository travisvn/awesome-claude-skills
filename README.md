...
| **[agntk](https://github.com/Phoenixrr2113/agntk)** | Zero-config AI agent CLI with 20+ built-in tools, persistent named agents, and hardware-aware local model detection via Ollama |
